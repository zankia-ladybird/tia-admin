	...
	<body>
		...
		<d:form id="queryForm" title="权限分配" labelWidth="80">
			<d:line columnWidth="0.5">
				<d:field name="role_id"  options="role_ds" valueField="role_id" displayField="role_name" value="1" width="200" editor="combo" prompt="角色选择">
		...
		<d:grid id="roleGrid" queryUrl="sys/power.query" selectFirstRow="false" title="功能列表" queryForm="queryForm" height="$D.getFullHeight('roleGrid')" autoQuery="true" pagerSize="100">
			<d:toolBar>
